export const en = { open: 'Open Tylina', close: 'Hide editor', title: 'Tylina', drafts: 'Browser drafts',
  pin: 'Pin this workspace', unpin: 'Follow the current conversation',
  retryOpen: 'Retry opening workspace',
  website: 'Tylina website', webEditor: 'Open the Web editor',
  mcp: 'Connect an MCP client', copyMcp: 'Copy configuration', copied: 'Copied',
  mcpHint: 'Give another MCP client access to this live document’s tools, including import, editing, Typst compilation and Skills.',
  ...
  session: 'Conversation', directory: 'Subfolder path', subfolder: 'Choose a subfolder', choose: 'Open a workspace',
  hint: 'Write beside your agent, in the same workspace.',
  ...
  toolInput: 'Input', toolOutput: 'Output', toolInspect: 'Inspect', toolImages: 'Images returned: {count}.',
  loading: 'Opening project…', noSession: 'Create or select a Harness session to open its document project.',
  cancel: 'Cancel', saveFailed: 'Resolve the document’s save issue before continuing.',
...
export const zh: typeof en = { open: '打开 Tylina', close: '隐藏编辑器', title: 'Tylina', drafts: '浏览器草稿',
  pin: '固定此工作区', unpin: '跟随当前会话',
  retryOpen: '重新打开工作区',
  website: 'Tylina 官网', webEditor: '打开 Web 编辑器',
  mcp: '连接 MCP 客户端', copyMcp: '复制配置', copied: '已复制',
  mcpHint: '让其他 MCP 客户端使用此实时文档的工具，包括导入、编辑、Typst 编译与 Skills。',
  mcpExpiry: '配置包含此项目的私密访问密钥，关闭编辑器、重连或切换项目后失效。Harness 已经可以使用这些工具。',
  session: '会话', directory: '子目录路径', subfolder: '选择子目录', choose: '打开工作区',
  hint: '与 Agent 共用工作区，一起完成文档。',
  submit: '打开项目', change: '切换项目', chat: '聚焦此会话', retry: '重新连接 Agent 工具', loading: '正在打开项目…',
  reconnecting: '正在重新连接 Agent 工具…',
  toolInput: '输入', toolOutput: '输出', toolInspect: '检查', toolImages: '返回图片：{count} 张。',
  noSession: '先创建或选择一个 Harness 会话，再打开其文档项目。', cancel: '取消',
