...
run(process.execPath, [join(sourceRoot, 'scripts/prepare-web-runtime.mjs')])
run('pnpm', ['--filter', '@tylina/web', 'build'])
if (target !== 'wasm') run(process.execPath, [join(sourceRoot, 'scripts/prepare-desktop-runtime.mjs')])
